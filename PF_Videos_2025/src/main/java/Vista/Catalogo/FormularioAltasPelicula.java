...
public Pelicula getPelicula() {
   ...
   private void inicializarFiltros() {
    ...
    DocumentFilter alfanumericoFilter = new Vista.Filtros.AlfanumericoFilter();
    ((javax.swing.text.AbstractDocument) caja_titulo.getDocument()).setDocumentFilter(alfanumericoFilter);
    ((javax.swing.text.AbstractDocument) caja_director.getDocument()).setDocumentFilter(alfanumericoFilter);

    DocumentFilter soloNumerosFilter = new Vista.Filtros.SoloNumerosFilter();
    MaximoDigitosFilter maxFinanzasFilter = new Vista.Filtros.MaximoDigitosFilter(6);
    
    ((javax.swing.text.AbstractDocument) caja_precioAlquiler.getDocument()).setDocumentFilter(maxFinanzasFilter);
    ((javax.swing.text.AbstractDocument) caja_precioAlquiler.getDocument()).setDocumentFilter(soloNumerosFilter);
    
    ((javax.swing.text.AbstractDocument) caja_costoAdquisicion.getDocument()).setDocumentFilter(maxFinanzasFilter);
    ((javax.swing.text.AbstractDocument) caja_costoAdquisicion.getDocument()).setDocumentFilter(soloNumerosFilter);
    
    MaximoDigitosFilter stockFilter = new Vista.Filtros.MaximoDigitosFilter(4);
    
    ((javax.swing.text.AbstractDocument) caja_stockTotal.getDocument()).setDocumentFilter(stockFilter);
    ((javax.swing.text.AbstractDocument) caja_stockTotal.getDocument()).setDocumentFilter(soloNumerosFilter);
}
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jLabel5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 396, Short.MAX_VALUE))
