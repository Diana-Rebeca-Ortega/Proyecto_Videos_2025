...
private Pelicula peliculaActual; 
    ...
    /**
     * Creates new form ModificacionesPelicula
     */
   public ModificacionesPelicula(java.awt.Frame parent, boolean modal, int idPelicula) {
        ...
        this.setLocationRelativeTo(parent); // Centrar el diálogo
    }
    ...
    public final void cargarDatosPelicula(int idPelicula) {
     PeliculaDAO dao = new PeliculaDAO();
        try {
            // 1. Obtiene el objeto Pelicula completo
            ...
            if (peliculaActual != null) {
                ...
                // Asegura que la categoría exista en el JComboBox
                combo_categoria.setSelectedItem(peliculaActual.getCategoria());
                
                // Conversión de números a String para los JTextFields
                // caja_precioAlquiler => alquiler_diario
                caja_precioAlquiler.setText(String.valueOf(peliculaActual.getPrecioAlquiler())); 
                // caja_costoAdquisicion => coste_venta
    ...
    private void btn_cambiarPeliculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cambiarPeliculaActionPerformed
     String tituloStr = caja_titulo.getText().trim();
        ...
        try {
            ...
            // 4. Validar que los valores numéricos sean válidos (no negativos)
            ...
            // 5. Crear el objeto Pelicula con los nuevos valores
            Pelicula peliculaModificada = new Pelicula();
            peliculaModificada.setIdPelicula(this.idPelicula); // ¡CRUCIAL: Mantener el ID original!
            ...
            // 6. Ejecutar la MODIFICACIÓN en la base de datos
            PeliculaDAO dao = new PeliculaDAO();
