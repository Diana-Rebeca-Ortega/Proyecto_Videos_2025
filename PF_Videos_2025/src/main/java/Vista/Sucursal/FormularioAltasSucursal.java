...
public class FormularioAltasSucursal extends javax.swing.JDialog {
    ...
    public FormularioAltasSucursal(java.awt.Frame parent, boolean modal) {
       ...
       AlfanumericoFilter alfanumericoFilter = new AlfanumericoFilter();
       ((AbstractDocument) caja_nombreSucursal.getDocument()).setDocumentFilter(alfanumericoFilter);
    ...
    // ? Definición de constantes de color modernas
    private static final Color COLOR_FONDO_BLANCO = Color.decode("#FFFFFF");
    private static final Color COLOR_TEXTO_GRIS = Color.decode("#333333");
    private static final Color COLOR_GUARDAR = Color.decode("#4CAF50"); // Verde
    private static final Color COLOR_CANCELAR = Color.decode("#F44336"); // Rojo
    private static final Color COLOR_BORDE_SUAVE = Color.decode("#CCCCCC"); // Gris claro
    private void aplicarEstiloModerno() {
        ...
        // Título Principal "REGISTRAR NUEVA SUCURSAL" (jLabel17)
        jLabel17.setFont(new Font("Segoe UI", Font.BOLD, 28));
        jLabel17.setForeground(COLOR_TEXTO_GRIS);

        // Etiquetas de Fecha (jLabel15, jLabel16)
        jLabel16.setForeground(COLOR_TEXTO_GRIS.darker());
        jLabel15.setForeground(COLOR_TEXTO_GRIS);
        ...
        Border padding = javax.swing.BorderFactory.createEmptyBorder(10, 20, 10, 20);
        
        // Botón GUARDAR (btn_altasClientes)
        btn_altasClientes.setBackground(COLOR_GUARDAR);
        btn_altasClientes.setForeground(Color.WHITE);
        btn_altasClientes.setFont(new Font("Segoe UI", Font.BOLD, 14));
        btn_altasClientes.setBorder(padding);
        
        // Botón CANCELAR (btn_cancelarRegistroCliente)
        btn_cancelarRegistroCliente.setBackground(COLOR_CANCELAR);
        btn_cancelarRegistroCliente.setForeground(Color.WHITE);
        btn_cancelarRegistroCliente.setFont(new Font("Segoe UI", Font.BOLD, 14));
        btn_cancelarRegistroCliente.setBorder(padding);
        
        // 4. CONFIGURACIÓN DE CAMPOS DE ENTRADA
        Border lineBorder = javax.swing.BorderFactory.createLineBorder(COLOR_BORDE_SUAVE, 1);
        Border compoundBorder = javax.swing.BorderFactory.createCompoundBorder(
            lineBorder,
    ...
    private void initComponents() {
        ...
        caja_calle.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                caja_calleActionPerformed(evt);
            }
        });
        ...
        caja_CP.setToolTipText("Solo 5 digitos");
        ...
        caja_nombreSucursal.setToolTipText("");
        ...
        caja_Telefono.setToolTipText("Solo 10 digitos");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btn_altasClientes, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(54, 54, 54))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(81, 81, 81)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void caja_calleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caja_calleActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_caja_calleActionPerformed
